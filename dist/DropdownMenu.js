...
const DropdownMenu = ({
  ...
  }, placeholder !== undefined && placeholder !== false && /*#__PURE__*/React.createElement("option", {
    className: "dropdown-option",
    value: ""
  }, placeholder), options && typeof options[0] === 'string' && options.map((option, i) => /*#__PURE__*/React.createElement("option", {
    className: "dropdown-option",
    value: option.toLowerCase().replace(' ', '_'),
    key: `ssm-${i}`
  }, option)), options && typeof options[0] === 'object' && options.map((option, i) => /*#__PURE__*/React.createElement("option", {
    className: "dropdown-option",
    value: option.value,
    key: `ssm-${i}`
  }, option.name))));
...
DropdownMenu.propTypes = {
  ...
  options: PropTypes.arrayOf(PropTypes.oneOfType([PropTypes.string, PropTypes.objectOf(PropTypes.string)]).isRequired),
  placeholder: PropTypes.oneOfType([PropTypes.string, PropTypes.bool]),
  log: PropTypes.bool,
  setvalue: PropTypes.func.isRequired,
  initComponent: PropTypes.objectOf(PropTypes.oneOfType([PropTypes.bool, PropTypes.func]).isRequired)
};
